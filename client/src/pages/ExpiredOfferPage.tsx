            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16">
              ...
              <div className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-primary/50 transition-all duration-500 bg-card md:col-span-2 lg:col-span-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-base text-foreground/70">Projeto MBA - FABRANI/Elias Evangelista</p>
                </div>
              </div>
              ...
              <div className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-primary/50 transition-all duration-500 bg-card">
                ...
                <div className="p-6">
                  ...
                  <p className="text-base text-foreground/70">Certificação FABRANI</p>
                </div>
              </div>
              ...
              <div className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-primary/50 transition-all duration-500 bg-card">
                ...
                <div className="p-6">
                  ...
                  <p className="text-base text-foreground/70">Projeto Validade e Certificado Elias Evangelista/FABRANI</p>
                </div>
              </div>
            </div>
          ...
          <div className="container max-w-5xl relative z-10">
            <div className="glass-card rounded-3xl p-8 md:p-12 border-primary relative overflow-hidden bg-background">
              ...
              <div className="relative z-10">
                ...
                <div className="mb-12">
                  <h3 className="text-2xl font-bold text-center text-foreground mb-8">Veja tudo o que você ia receber:</h3>
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="text-center p-6 rounded-xl bg-primary/20 border border-primary/30">
                ...
                <div className="flex flex-col items-center gap-4">
                  <Button 
                    size="lg" 
                    className="h-auto w-full sm:w-auto text-foreground text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 bg-red-600 hover:bg-red-700" 
                    asChild
                    onClick={handleCTAClick}
                  >
