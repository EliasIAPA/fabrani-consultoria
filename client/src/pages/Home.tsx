...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-black">
      ...
      <main>
        {/* ========================================
             1. HERO SECTION — MUDANÇA DE CATEGORIA
        ========================================= */}
        ...
        {/* ========================================
             3. O CUSTO INVISÍVEL DE PERMANECER NA MESMA CATEGORIA
        ========================================= */}
        ...
        {/* ========================================
             4. O SHIFT — ENTRADA NA EDUCAÇÃO FORMAL
        ========================================= */}
        <section className="py-24 bg-card relative">
          <div className="container">
            <div className="max-w-4xl mx-auto space-y-12">
        ...
        {/* ========================================
             5. O MECANISMO DE AVALIAÇÃO ACADÊMICA
        ========================================= */}
        <section className="py-24 bg-background relative">
          <div className="container">
            <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="glass-card rounded-3xl p-8 md:p-12 border-primary relative overflow-hidden bg-card">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-primary">
                  Próximo Passo: Avaliação Acadêmica Gratuita
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-12">
                  <div className="space-y-6">
                    {[
                      {
                        title: "Análise Completa do Seu Curso",
                        desc: "Avaliação acadêmica profunda para validar se está pronto para Extensão Universitária.",
                      },
                      {
                        title: "Parecer Técnico Personalizado",
                        desc: "Documento detalhado com recomendações específicas para seu modelo.",
                      },
                      {
                        title: "Roadmap de Implementação",
                        desc: "Plano claro de próximos passos se seu curso for aprovado.",
                      },
                      {
                        title: "Sem Custo, Sem Compromisso",
                        desc: "Avaliação totalmente gratuita. Você decide depois.",
                      }
                    ].map((item, i) => (
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="bg-gradient-to-b from-primary/20 to-purple-600/20 rounded-2xl p-8 text-center space-y-6">
                      <h3 className="text-2xl font-bold text-foreground">
                        Transforme Seu Curso em Educação Formal
                      </h3>
                      <p className="text-foreground/80">
                        Agende sua avaliação acadêmica gratuita agora e descubra se seu curso pode receber a chancela do MEC.
                      </p>
                      <Button 
                        size="lg" 
                      ...
                      <p className="text-xs text-foreground/60">
                        ✓ Avaliação Gratuita • ✓ Sem Compromisso • ✓ Resposta em 24h
                      </p>
                    </div>
                  </div>
                </div>
